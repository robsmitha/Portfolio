...
DROP TABLE IF EXISTS `smithadb`.`blogcategory`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcategory_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcategory_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcategory_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcategory_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcategory_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcategory_Search`;
...
CREATE TABLE `smithadb`.`blogcategory` (
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcategory_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcategory_LoadAll`
()
BEGIN
	SELECT
		`blogcategory`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcategory_Add`
(
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcategory_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcategory_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcategory_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `smithadb`.`itemtype`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_itemtype_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_itemtype_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_itemtype_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_itemtype_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_itemtype_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_itemtype_Search`;
...
CREATE TABLE `smithadb`.`itemtype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_itemtype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_itemtype_LoadAll`
()
BEGIN
	SELECT
		`itemtype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_itemtype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_itemtype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_itemtype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_itemtype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `smithadb`.`blogcommentstatustype`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcommentstatustype_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcommentstatustype_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcommentstatustype_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcommentstatustype_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcommentstatustype_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcommentstatustype_Search`;
...
CREATE TABLE `smithadb`.`blogcommentstatustype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcommentstatustype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcommentstatustype_LoadAll`
()
BEGIN
	SELECT
		`blogcommentstatustype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcommentstatustype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcommentstatustype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcommentstatustype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcommentstatustype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `smithadb`.`cartstatustype`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cartstatustype_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cartstatustype_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cartstatustype_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cartstatustype_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cartstatustype_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cartstatustype_Search`;
...
CREATE TABLE `smithadb`.`cartstatustype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartstatustype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartstatustype_LoadAll`
()
BEGIN
	SELECT
		`cartstatustype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartstatustype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartstatustype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartstatustype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartstatustype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `smithadb`.`eventcommentstatustype`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventcommentstatustype_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventcommentstatustype_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventcommentstatustype_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventcommentstatustype_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventcommentstatustype_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventcommentstatustype_Search`;
...
CREATE TABLE `smithadb`.`eventcommentstatustype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcommentstatustype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcommentstatustype_LoadAll`
()
BEGIN
	SELECT
		`eventcommentstatustype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcommentstatustype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcommentstatustype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcommentstatustype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcommentstatustype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `smithadb`.`eventtype`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventtype_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventtype_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventtype_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventtype_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventtype_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventtype_Search`;
...
CREATE TABLE `smithadb`.`eventtype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventtype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventtype_LoadAll`
()
BEGIN
	SELECT
		`eventtype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventtype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventtype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventtype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventtype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `smithadb`.`imagecommentstatustype`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_imagecommentstatustype_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_imagecommentstatustype_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_imagecommentstatustype_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_imagecommentstatustype_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_imagecommentstatustype_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_imagecommentstatustype_Search`;
...
CREATE TABLE `smithadb`.`imagecommentstatustype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecommentstatustype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecommentstatustype_LoadAll`
()
BEGIN
	SELECT
		`imagecommentstatustype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecommentstatustype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecommentstatustype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecommentstatustype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecommentstatustype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `smithadb`.`itemstatustype`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_itemstatustype_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_itemstatustype_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_itemstatustype_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_itemstatustype_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_itemstatustype_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_itemstatustype_Search`;
...
CREATE TABLE `smithadb`.`itemstatustype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_itemstatustype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_itemstatustype_LoadAll`
()
BEGIN
	SELECT
		`itemstatustype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_itemstatustype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_itemstatustype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_itemstatustype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_itemstatustype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `smithadb`.`role`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_role_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_role_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_role_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_role_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_role_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_role_Search`;
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_role_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_role_LoadAll`
()
BEGIN
	SELECT
		`role`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_role_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_role_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_role_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_role_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `smithadb`.`securityuser`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_securityuser_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_securityuser_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_securityuser_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_securityuser_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_securityuser_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_securityuser_Search`;
...
CREATE TABLE `smithadb`.`securityuser` (
Id INT AUTO_INCREMENT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_securityuser_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_securityuser_LoadAll`
()
BEGIN
	SELECT
		`securityuser`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_securityuser_Add`
(
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_securityuser_Update`
(
	IN paramId INT,
	IN paramUsername VARCHAR(255),
	IN paramPassword VARCHAR(255),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_securityuser_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_securityuser_Search`
(
	IN paramId INT,
	IN paramUsername VARCHAR(255),
	IN paramPassword VARCHAR(255),
...
DROP TABLE IF EXISTS `smithadb`.`customer`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_customer_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_customer_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_customer_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_customer_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_customer_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_customer_Search`;
...
CREATE TABLE `smithadb`.`customer` (
Id INT AUTO_INCREMENT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_customer_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_customer_LoadAll`
()
BEGIN
	SELECT
		`customer`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_customer_Add`
(
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_customer_Update`
(
	IN paramId INT,
	IN paramFirstName VARCHAR(255),
	IN paramLastName VARCHAR(255),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_customer_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_customer_Search`
(
	IN paramId INT,
	IN paramFirstName VARCHAR(255),
	IN paramLastName VARCHAR(255),
...
DROP TABLE IF EXISTS `smithadb`.`blog`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blog_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blog_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blog_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blog_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blog_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blog_Search`;
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blog_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blog_LoadAll`
()
BEGIN
	SELECT
		`blog`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blog_Add`
(
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blog_Update`
(
	IN paramId INT,
	IN paramTitle VARCHAR(255),
	IN paramDescription VARCHAR(32768),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blog_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blog_Search`
(
	IN paramId INT,
	IN paramTitle VARCHAR(255),
	IN paramDescription VARCHAR(32768),
...
DROP TABLE IF EXISTS `smithadb`.`blogcomment`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcomment_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcomment_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcomment_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcomment_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcomment_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_blogcomment_Search`;
...
CREATE TABLE `smithadb`.`blogcomment` (
Id INT AUTO_INCREMENT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcomment_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcomment_LoadAll`
()
BEGIN
	SELECT
		`blogcomment`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcomment_Add`
(
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcomment_Update`
(
	IN paramId INT,
	IN paramComment VARCHAR(32768),
	IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcomment_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcomment_Search`
(
	IN paramId INT,
	IN paramComment VARCHAR(32768),
	IN paramCustomerId INT,
...
DROP TABLE IF EXISTS `smithadb`.`cart`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cart_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cart_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cart_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cart_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cart_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cart_Search`;
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cart_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cart_LoadAll`
()
BEGIN
	SELECT
		`cart`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cart_Add`
(
	 IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cart_Update`
(
	IN paramId INT,
	IN paramCustomerId INT,
	IN paramCartStatusTypeId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cart_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cart_Search`
(
	IN paramId INT,
	IN paramCustomerId INT,
	IN paramCartStatusTypeId INT,
...
DROP TABLE IF EXISTS `smithadb`.`item`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_item_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_item_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_item_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_item_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_item_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_item_Search`;
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_item_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_item_LoadAll`
()
BEGIN
	SELECT
		`item`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_item_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025),
	 IN paramImgUrl VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_item_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_item_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_item_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DROP TABLE IF EXISTS `smithadb`.`cartitem`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cartitem_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cartitem_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cartitem_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cartitem_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cartitem_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_cartitem_Search`;
...
CREATE TABLE `smithadb`.`cartitem` (
Id INT AUTO_INCREMENT,
CartId INT,
ItemId INT,
AddDate DATETIME,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartitem_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartitem_LoadAll`
()
BEGIN
	SELECT
		`cartitem`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartitem_Add`
(
	 IN paramCartId INT,
	 IN paramItemId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartitem_Update`
(
	IN paramId INT,
	IN paramCartId INT,
	IN paramItemId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartitem_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartitem_Search`
(
	IN paramId INT,
	IN paramCartId INT,
	IN paramItemId INT,
...
DROP TABLE IF EXISTS `smithadb`.`event`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_event_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_event_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_event_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_event_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_event_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_event_Search`;
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_event_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_event_LoadAll`
()
BEGIN
	SELECT
		`event`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_event_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025),
	 IN paramImgUrl VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_event_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_event_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_event_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DROP TABLE IF EXISTS `smithadb`.`eventcomment`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventcomment_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventcomment_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventcomment_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventcomment_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventcomment_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_eventcomment_Search`;
...
CREATE TABLE `smithadb`.`eventcomment` (
Id INT AUTO_INCREMENT,
Comment VARCHAR(32768),
CustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcomment_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcomment_LoadAll`
()
BEGIN
	SELECT
		`eventcomment`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcomment_Add`
(
	 IN paramComment VARCHAR(32768),
	 IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcomment_Update`
(
	IN paramId INT,
	IN paramComment VARCHAR(32768),
	IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcomment_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcomment_Search`
(
	IN paramId INT,
	IN paramComment VARCHAR(32768),
	IN paramCustomerId INT,
...
DROP TABLE IF EXISTS `smithadb`.`image`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_image_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_image_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_image_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_image_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_image_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_image_Search`;
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_image_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_image_LoadAll`
()
BEGIN
	SELECT
		`image`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_image_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025),
	 IN paramImgUrl VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_image_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_image_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_image_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DROP TABLE IF EXISTS `smithadb`.`imagecomment`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_imagecomment_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_imagecomment_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_imagecomment_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_imagecomment_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_imagecomment_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_imagecomment_Search`;
...
CREATE TABLE `smithadb`.`imagecomment` (
Id INT AUTO_INCREMENT,
Comment VARCHAR(32768),
CustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecomment_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecomment_LoadAll`
()
BEGIN
	SELECT
		`imagecomment`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecomment_Add`
(
	 IN paramComment VARCHAR(32768),
	 IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecomment_Update`
(
	IN paramId INT,
	IN paramComment VARCHAR(32768),
	IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecomment_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecomment_Search`
(
	IN paramId INT,
	IN paramComment VARCHAR(32768),
	IN paramCustomerId INT,
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_blogcomment_LoadByBlogId`
(
	 IN paramBlogId INT
)
BEGIN
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartitem_CalculateTotal`
(
	 IN paramCartId INT
)
BEGIN
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartitem_GetCartCount`
(
	 IN paramCartId INT
)
BEGIN
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cart_LoadByCustomerId`
(
	 IN paramCustomerId INT
)
BEGIN
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartitem_LoadOnlineCart`
(
	 IN paramCartId INT
)
BEGIN
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_customer_Lookup`
(
	IN paramEmail VARCHAR(255)
)
BEGIN
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_eventcomment_LoadByEventId`
(
	 IN paramEventId INT
)
BEGIN
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_imagecomment_LoadByImageId`
(
	 IN paramImageId INT
)
BEGIN
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_securityuser_Lookup`
(
	IN paramUsername VARCHAR(255)
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_image_LoadFeaturedImages`
()
BEGIN
	SELECT
		`image`.`Id` AS `Id`,
...
DROP TABLE IF EXISTS `smithadb`.`orderstatustype`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_orderstatustype_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_orderstatustype_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_orderstatustype_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_orderstatustype_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_orderstatustype_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_orderstatustype_Search`;
...
CREATE TABLE `smithadb`.`orderstatustype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderstatustype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderstatustype_LoadAll`
()
BEGIN
	SELECT
		`orderstatustype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderstatustype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderstatustype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderstatustype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderstatustype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `smithadb`.`order`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_order_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_order_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_order_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_order_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_order_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_order_Search`;
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_order_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_order_LoadAll`
()
BEGIN
	SELECT
		`order`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_order_Add`
(
	 IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_order_Update`
(
	IN paramId INT,
	IN paramCustomerId INT,
	IN paramOrderStatusTypeId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_order_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_order_Search`
(
	IN paramId INT,
	IN paramCustomerId INT,
	IN paramOrderStatusTypeId INT,
...
DROP TABLE IF EXISTS `smithadb`.`orderitem`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_orderitem_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_orderitem_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_orderitem_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_orderitem_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_orderitem_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_orderitem_Search`;
...
CREATE TABLE `smithadb`.`orderitem` (
Id INT AUTO_INCREMENT,
OrderId INT,
ItemId INT,
Quantity INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderitem_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderitem_LoadAll`
()
BEGIN
	SELECT
		`orderitem`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderitem_Add`
(
	 IN paramOrderId INT,
	 IN paramItemId INT,
	 IN paramQuantity INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderitem_Update`
(
	IN paramId INT,
	IN paramOrderId INT,
	IN paramItemId INT,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderitem_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderitem_Search`
(
	IN paramId INT,
	IN paramOrderId INT,
	IN paramItemId INT,
...
DROP TABLE IF EXISTS `smithadb`.`portfoliocategory`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_portfoliocategory_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_portfoliocategory_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_portfoliocategory_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_portfoliocategory_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_portfoliocategory_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_portfoliocategory_Search`;
...
CREATE TABLE `smithadb`.`portfoliocategory` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfoliocategory_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfoliocategory_LoadAll`
()
BEGIN
	SELECT
		`portfoliocategory`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfoliocategory_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfoliocategory_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfoliocategory_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfoliocategory_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `smithadb`.`portfolioitem`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_portfolioitem_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_portfolioitem_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_portfolioitem_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_portfolioitem_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_portfolioitem_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_portfolioitem_Search`;
...
CREATE TABLE `smithadb`.`portfolioitem` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfolioitem_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfolioitem_LoadAll`
()
BEGIN
	SELECT
		`portfolioitem`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfolioitem_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfolioitem_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfolioitem_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfolioitem_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_order_LoadByCustomerId`
(
	 IN paramCustomerId INT
)
BEGIN
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_orderitem_LoadByOrderId`
(
	 IN paramOrderId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_portfolioitem_LoadByPortfolioCategoryId`
(
	 IN paramPortfolioCategoryId INT
)
BEGIN
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_image_LoadByEventId`
(
	 IN paramId INT
)
BEGIN
...
use smithadb;
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_cartitem_LoadByCartId`
(
	 IN paramCartId INT
)
BEGIN
