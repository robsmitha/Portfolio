...
DROP TABLE IF EXISTS `smithadb`.`emaillog`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_emaillog_Load`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_emaillog_LoadAll`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_emaillog_Add`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_emaillog_Update`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_emaillog_Delete`;
DROP PROCEDURE IF EXISTS `smithadb`.`usp_emaillog_Search`;
...
CREATE TABLE `smithadb`.`emaillog` (
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_emaillog_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_emaillog_LoadAll`
()
BEGIN
	SELECT
		`emaillog`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_emaillog_Add`
(
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_emaillog_Update`
(
	IN paramId INT,
	IN paramEmail VARCHAR(255),
	IN paramSentDate DATETIME,
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_emaillog_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `smithadb`.`usp_emaillog_Search`
(
	IN paramId INT,
	IN paramEmail VARCHAR(255),
	IN paramSentDate DATETIME,
